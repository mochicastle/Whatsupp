...
const WildcardForm = (props) => {
  ...
  const wildcardTileComponent = (wildcardPick) => {
    return <WildcardTile wildcardPick={wildcardPick} />;
  };
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid-x  grid-margin-x">
              <div className="cell small-12">
                <label htmlFor="cuisine" className="wildcard-font text-center">
                  Cuisine:
                  <input
                    className="cuisineTextBoxSizing centered-input"
                    typearea="text"
                    id="cuisine"
                    name="categories"
            ...
            <div className="cell small-12">
              <label htmlFor="radius" className="wildcard-font distance-margin text-center">
                Distance: within
                <input
                  className="radiusTextBoxSizing centered-input"
                  typearea="text"
                  name="radius"
                  onChange={handleInputChange}
              ...
              <fieldset className="price-margin text-center">
                <legend>
                  ...
                  <input
                    ...
                    name="options"
                    value="1"
                    onChange={addToPriceArray}
                  />
                  <label htmlFor="option1" className="wildcard-font">
                    $
                  </label>
                  <input
                    type="checkbox"
                    ...
                    onChange={addToPriceArray}
                  />
                  <label htmlFor="option2" className="wildcard-font">
                    $$
                  </label>
                  <input
                    type="checkbox"
                    ...
                    onChange={addToPriceArray}
                  />
                  <label htmlFor="option3" className="wildcard-font">
                    $$$
                  </label>
                  <input
                    type="checkbox"
                    ...
                    onChange={addToPriceArray}
                  />
                  <label htmlFor="option4" className="wildcard-font">
                    $$$$
                  </label>
                </legend>
              </fieldset>
